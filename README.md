...
*Note: To comply with GitHub's file size limits, the final `.safetensors` model weights and the 5GB dataset are not included in this repository. You must generate the model locally.*
...
👨‍💻 Author
Akshay Saxena B.Tech Computer Science Engineering (Core) VIT Bhopal Developed as a "Bring Your Own Project" submission demonstrating end-to-end AI application architecture, from raw data processing and hardware-constrained model training to final UI/UX deployment.
